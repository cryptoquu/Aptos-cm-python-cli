...
class RestClient(client.RestClient):
    ...
    def get_events_by_handle(self, account_address: AccountAddress, event_handle: str, field_name:str):
        """Returns the sequence number and authentication key for an account"""

        response = self.client.get(f"{self.base_url}/accounts/{account_address}/events/{event_handle}/{field_name}")
